         ...
         <div style="padding-bottom: 10px; border-bottom: 1px solid #ccc">在线用户<span style="font-size: 12px">（点击聊天气泡开始聊天）</span></div>
          <div style="padding: 10px 0" v-for="user in users" :key="user.username">
            ...
            <el-icon class="el-icon-chat-dot-round" style="margin-left: 10px; font-size: 16px; cursor: pointer"
               @click="chatUser = user.username"><chat-round /></el-icon>
  ...
  methods: {
    ...
    createContent(remoteUser, nowUser, text) {  // 这个方法是用来将 json的聊天消息数据转换成 html的。
      ...
      if (nowUser) { // nowUser 表示是否显示当前用户发送的聊天消息，绿色气泡
        html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
            ...
            "    <img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkFQ7DG1QUaV_dsziAn7e2I8_gHtidBylepw&usqp=CAU\" style=\"object-fit: cover;\">\n" +
            "  </span>\n" +
            "  </div>\n" +
            "</div>";
        ...
        html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
            ...
            "  <span class=\"el-avatar el-avatar--circle\" style=\"height: 40px; width: 40px; line-height: 40px;\">\n" +
            "    <img src=\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnByB_oqS_m9BPYFKzVinC2zlP90vEFjNL2g&usqp=CAU\" style=\"object-fit: cover;\">\n" +
            "  </span>\n" +
            "  </div>\n" +
    ...
    init() {
      ...
      if (typeof (WebSocket) == "undefined") {
        ...
        console.log("您的浏览器支持WebSocket");
        let socketUrl = "ws://118.31.251.4:9200/imserver/" + username;
        if (socket != null) {
          socket.close();
          socket = null;
        }
