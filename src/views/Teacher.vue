    ...
    <div style="margin: 10px 0">
      ...
      <el-dialog title="提示" v-model="dialogVisible" width="30%">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="导师姓名"><el-input v-model="form.name" /></el-form-item>   
          ...
          <el-form-item label="选择日期">
           ...
           <el-form-item label="选择照片">
            <el-upload ref="upload" action="http://118.31.251.4:9200/file/upload/oss/teacher" :on-success="filesUploadSuccess">
...
export default {
  ...
  data() {
    return {
      ...
      pageSize: 5,
      total: 0,
      // filesUploadUrl: "http://" + window.server.filesUploadUrl + ":9200/file/upload/oss/teacher",
      tableData: [
  ...
  methods: {
    ...
    // 加载
    load(){
      request.get("/teacher/teacherQueryPage",{
        params:{
        search:this.search,
    ...
    save(){
       if(this.form.id) {
         request.put("/teacher/editTeacher",this.form).then(res =>{
           if(res.code === '0') {
           this.$message({
           type:"success",
           message:"修改成功"
